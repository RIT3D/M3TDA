...
def generate_experiment_cfgs(id):
    ...
    def config_from_vars():
        ...
        if uda == 'target-only':
            ...
            cfg['_base_'].append(
                f'_base_/datasets/mtda_{source}_to_{target}_{target2}_{crop}.py')
        ...
        cfg['name'] = f'{source}2{target}{target2}{crop_name}_{uda_mod}_' \
        ...
        cfg['exp'] = id
        cfg['name_dataset'] = f'{source}2{target}{target2}{crop_name}'
    ...
    # -------------------------------------------------------------------------
        ...
        for architecture,                      backbone,  uda_hp in [
            ...
            if 'hrda' in architecture:
                source, target, target2, crop = 'gtaHR', 'cityscapesHR', 'mapillaryHR', '1024x1024'
                ...
                source, target, target2, crop = 'gta', 'cityscapes', 'mapillary', '512x512'
                rcs_min_crop = 0.5
